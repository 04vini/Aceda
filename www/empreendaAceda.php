...
>>>>>>> 1460ce5dfdd8bb94cd2a3e2542e79a539a4d04ac
</head>
<body>
    <!-- NavBar -->
    ...
    <section class="container">
        ...
        <form method="post" action="insert-empreenda.php" enctype="multipart/form-data" class="">
            <div class="mb-3">
            ...
            <div class="form-check mb-3">
                <input class="form-check-input" type="radio" name="flexLogo" id="flexLogoN" value="NÃO">
                <label class="form-check-label" for="flexLogoN">NÃO</label>
            </div>

            <div class="mb-3">
                <label for="formLogo" class="form-label">Envie sua LogoMarca</label>
                <input class="form-control form-control-lg" id="formLogo" name="formLogo" type="file">
            </div>
