    ...
    <section class="container">
        ...
        <form>
            ...
            <div class="form-check mb-3">
                ...
                <input class="form-check-input" type="radio" name="flexSabesp" id="flexSabesp">
                <label class="form-check-label" for="flexSabesp">
                  Sabesp
                </label>
            </div>
            <div class="form-check mb-3">
                <input class="form-check-input" type="radio" name="flexEnel" id="flexEnel">
                <label class="form-check-label" for="flexEnel">
                  Enel
                </label>
            </div>
            <div class="form-check mb-3">
                <input class="form-check-input" type="radio" name="flexInss" id="flexInss">
                <label class="form-check-label" for="flexInss">
                  Inss
                </label>
            </div>
            <div class="form-check mb-3">
                <input class="form-check-input" type="radio" name="flexImpressao" id="flexImpressao">
                <label class="form-check-label" for="flexImpressao">
                    Impressões de documentos
                </label>
            </div>
            <div class="form-check mb-3">
                <input class="form-check-input" type="radio" name="flexSP" id="flexSP">
                <label class="form-check-label" for="flexSP">
                  SP156
                </label>
            </div>
            <div class="form-check mb-3">
                <input class="form-check-input" type="radio" name="flexPoupatempo" id="flexPoupatempo">
                <label class="form-check-label" for="flexPoupatempo">
                  Poupatempo
                </label>
            </div>
            <div class="form-check mb-3">
                <input class="form-check-input" type="radio" name="flexContrato" id="flexContrato">
                <label class="form-check-label mb-3" for="flexContrato">
                  Contratos
                </label>
                <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="InputSol" aria-describedby="solInfo">
            ...
            <div class="mb-3">
                ...
                <input class="form-control form-control-lg" id="formImg" type="file" aria-describedby="imgInfo">
                <div id="imgInfo" class="form-text">Atenção para geolocalização de sua solicitação orientamos que fotos e videos sejam tirados através do aplicativo  Timestamp Camera download:
                    https://play.google.com/store/apps/details?id=com.jeyluta.timestampcamerafree&pcampaignid=web_share</div>
            </div>
