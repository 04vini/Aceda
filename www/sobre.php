    ...
    <section class="p-5" style="background-color:#2C4D97;">
        <div class="container">
            ...
            <p class="text-center text-white">A ACEDA é uma organização sem fins lucrativos que atua como
                ...
                <br> de
                desenvolvimento
                socioeconômico no Distrito Anhanguera. <br>Uma associação fomentadora de investimentos, recursos e
                pessoas
                para o Distrito Anhanguera e
                região. <br>
                Nascemos da necessidade de representatividade dos nossos comerciantes no início dos anos 2000.
            </p>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-7 order-md-last">
                <div class="text-end p-4">
                    <p>
                        Em meados de 2006, os comerciantes do Distrito Anhanguera necessitaram de representatividade
                        ...
                        <div class="card-body shadow-custom">
                            ...
                            <div class="d-flex justify-content-center align-items-center">
                                <ul class="list-group text-start">
                                    ...
                                    <li class="list-group-item border-0">. Independência</li>
                                </ul>
                            </div>
                        </div>
                    </div>
