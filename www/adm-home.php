...
// Query para listar cursos
$queryCurso = "SELECT * FROM tb_curso_home ORDER BY id DESC";
$dadosCurso = mysqli_query($conn, $queryCurso);  
?>
            ...
            <div class="m-5">
                ...
                <div class="table-responsive">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php
                            $queryServico = "SELECT * FROM tb_servico_home ORDER BY id DESC";
                ...
                <div>
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <?php
                            if ($dadosCurso) {
                                while ($linhaCurso = mysqli_fetch_assoc($dadosCurso)) {
                                    ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div style="background-color: <?php echo $linhaCurso["cor_titulo"]; ?>; width: 50px; height: 20px;"></div>
                                        </td>
                                        <td>
