...
<body>
    ...
    <div style="background-color: #FFB14A;">
        <div class="container text-white">
            <div class="row">
                <div class="col-lg-5 col-md-12 text-center">
                    <h1 class="pt-4 pb-0 fw-bold display-5">SERVIÇOS</h1>
                    <img class="align-items-center img-fluid" src="assets/img/imagem-aceda-colorido-serviços.png"
                        alt="ACEDA Serviços">
                </div>
                <div class="col-lg-7 col-md-12">
                    <h3 class="m-lg-5 text-center pt-4 pb-3 fw-semibold">
    ...
    <section class="container mt-5 mb-5">
        <div class="row">
            <div class="col-12 col-md-5 order-md-first">
                <img src="../www/assets/img/monitora.png" class="img-fluid mt-3 rounded-2 shadow-custom img-square">
            </div>
            <div class="col-12 col-md-7 order-md-last">
                <div class="text-start p-4">
                    <h1 class="text-center fw-semibold">O seu parceiro em segurança comunitária!</h1>
                    <p class="text-start">Com mais de 35 câmeras estrategicamente posicionadas no bairro do Sol
