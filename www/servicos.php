...
<body>
    ...
    <!-- CABEÇALHO -->
    <div class="shadow-custom image-back" style="background-image: url('../www/assets/img/mãos-dadas.png'); background-position: center; margin-bottom: 10px;">
        <div class="container text-white">
            <div class="row">
                <div class="col-lg-5 col-md-12 text-center">
                    <h1 class="pt-4 pb-0 fw-bold display-5 shadow-custom-text">SERVIÇOS</h1>
                    <img class="align-items-center img-fluid" src="assets/img/logo-azul-aceda2x.png" alt="ACEDA Serviços">
                </div>
    ...
    <section class="container mt-1"> <!-- Reduzi a margem superior para 3 -->
        ...
        <div class="row mt-3">
            <div class="col-12 col-md-5 order-md-first">
                <div class="d-flex justify-content-center">
                    <video src="../www/assets/videos/Camerite video.mp4" class="mt-3 rounded-2 shadow" style="max-width: 56%; height: auto;" autoplay loop muted></video>
                </div>
            </div>
        ...
        <div class="container mt-3">
            <div class="row">
                ...
                <div class="col-12 col-md-5 text-center mt-2">
                    <img src="../www/assets/img/divulga-aceda-img14.jpeg" class="img-fluid mt-3 rounded-2 shadow mx-auto" style="max-width: 95%; max-height: 85%;">
                </div>
            </div>
        </div>
    </section>
